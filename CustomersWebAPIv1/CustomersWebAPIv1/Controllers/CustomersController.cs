...
namespace CustomersWebAPIv1.Controllers
{
    ...
    public class CustomerController : ControllerBase
    {
        ...
        /// </summary>
        /// <param name="id">ID of CustomerInfo whose Data is to be Retrieved</param>
        /// <remarks>
        /// Sample request:
        ///

        ///     Get /api/CustomerInfo/3
        ///
        /// </remarks>
        ...
        /// Sample request:
        ///
        ///     Delete /api/CustomerInfo/3
        ///
        /// </remarks>
        /// <response code="200">  If CustomerInfo is Deleted Successfully</response>
        ...
        public IActionResult Delete(string id)
        {
            ...
            foreach (var customer in allCustomersData.customers.Where(w => w.customerId == id))
            {
                ...
                else
                {
                    ...
                    {
                        statusCode = 202,
                        message = "successful Data Deletion- CustomerInfo Record Contains Locations. Remove Locations First",
                        data = customer
                    };
